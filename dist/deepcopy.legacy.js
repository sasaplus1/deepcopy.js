	...
	function recursiveCopy(value, clone, references, visited, customizer) {
	  ...
	  try {
	    for (var _iterator = keys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      var _collectionKey = _step.value;
	      var collectionValue = get(value, _collectionKey, type);

	      if (visited.has(collectionValue)) {
	        // for [Circular]
	        set(clone, _collectionKey, references.get(collectionValue), type);
	      } else {
	        ...
	        set(clone, _collectionKey, recursiveCopy(collectionValue, copiedCollectionValue, references, visited, customizer), type);
	      }
