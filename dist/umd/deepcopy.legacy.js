...
(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.deepcopy = {}));
	 ...
	 * @private
	 */
	var cloneBuffer = isBufferExists
	 ...
	 * @param type
	 */
	function copy(value, valueType, customizer) {
	...
	function recursiveCopy(value, clone, references, visited, customizer) {
	    ...
	    var copiedValue = copy(value, valueType);
	    // return if not a collection value
	    if (!isCollection(valueType)) {
	        return copiedValue;
	    }
	    var keys = /*#__INLINE__*/ getKeys(value, valueType);
	    // walk within collection with iterator
	    for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
	        var collectionKey = keys_1[_i];
	        var collectionValue = /*#__INLINE__*/ getValue(value, collectionKey, valueType);
	...
	function deepcopy(value, options) {
	    ...
	    _a = (options || {}).customizer
	    // TODO: max depth
	    // depth = Infinity,
	    , 
	    // TODO: before/after customizer
	    customizer = _a === void 0 ? null : _a
	    // TODO: max depth
	    // depth = Infinity,
	    ;
	    var valueType = detectType(value);
